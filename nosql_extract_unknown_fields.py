...
RAW_REQUEST = """
POST /login HTTP/2
Host: 0aea003b0461824480f01cf0009f00fa.web-security-academy.net
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:154.0) Gecko/20100101 Firefox/154.0
Accept: */*
Accept-Language: en-US,en;q=0.9
Accept-Encoding: gzip, deflate, br, zstd
Referer: https://0aea003b0461824480f01cf0009f00fa.web-security-academy.net/login
Content-Type: application/json
Content-Length: 39
Origin: https://0aea003b0461824480f01cf0009f00fa.web-security-academy.net
DNT: 1
Sec-GPC: 1
Connection: keep-alive
Cookie: session=xURehr0jVVKvisVs401lFL9ZnhByi8zY
...
async def main():
    ...
    await print_net_result(raw_req_5c, True)
